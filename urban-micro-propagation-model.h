#ifndef URBAN_MICRO_PROPAGATION_MODEL_H_
#define URBAN_MICRO_PROPAGATION_MODEL_H_

#include "lte-propagation-loss-model.h"

class UMi_PropagationLossModel : public LtePropagationLossModel {

public:
	UMi_PropagationLossModel();
	virtual ~UMi_PropagationLossModel();
